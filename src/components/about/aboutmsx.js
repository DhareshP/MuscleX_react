        ...
        <div>
            ...
            <div className=""> 
                ...
                <div
                    ...
                    style={{
                        backgroundImage: `url('https://images.pexels.com/photos/6456264/pexels-photo-6456264.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1')`
                    }}
                >
                ...
                <div className="max-w-7xl mx-auto py-12 px-6 lg:px-8">
                    ...
                    <p className="mt-4 text-gray-600">
                        At The Practice, we strive to provide the highest quality of health and wellness services to help you achieve your goals. We believe in a holistic approach to well-being, addressing both the mind and body.
                    </p>

                    <h2 className="text-3xl font-bold text-gray-800 mt-8">Meet Our Team</h2>
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mt-4">
                        <div className="bg-gray-50 p-6 rounded-lg shadow-lg">
                            <h3 className="text-xl font-semibold text-gray-800">Dharesh </h3>
                            <p className="text-gray-600">Founder & Self Learned Wellness Expert</p>
                            <p className="mt-2">
                                Dharesh is a expert in holistic wellness and has helped countless individuals achieve optimal health.
                            </p>
                        </div>
                        {/* <div className="bg-gray-50 p-6 rounded-lg shadow-lg">
